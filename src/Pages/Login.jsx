        ...
        <>
            <div className='flex' >
                <div className='w-full md:w-1/2 flex flex-col justify-center items-center p-8 md:p-12' >
                    <form onSubmit={handelSubmit} action="" className='w-full max-w-md bg-white p-8 rounded-lg boorder shadow-sm' >
                        ...
                        <div className='mb-4' >
                            ...
                            <input type="email" value={email} onChange={(e) => setEmail(e.target.value)}
                                className='w-full p-2 border rounded' placeholder='Enter your email address' id="" />
